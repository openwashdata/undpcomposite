...
#'
#' Composite indices from the UNDP Human Development Report 2023/2024 complete time series: the Human Development Index (HDI), the Gender Development Index (GDI), the Inequality-adjusted HDI (IHDI), the Gender Inequality Index (GII) and the Planetary pressures-adjusted HDI (PHDI), with their components, for 195 countries and territories and 11 UNDP aggregates (development groups, developing regions and the world). One row per country or aggregate and year, from 1990 to 2022. Not every index covers every year; missing values are NA.
#'
...
#'   \item{region}{UNDP developing regions}
...
#'   \item{ineq_edu}{Inequality in education}
...
#' }
#' @source Obtained from the UNDP Human Development Report 2023/2024, composite indices complete time series (\url{https://hdr.undp.org/data-center/documentation-and-downloads}), published under the Creative Commons Attribution 3.0 IGO licence.
#' @examples
